...
5. Controlar parámetros sonoros con Tone.js.
...
- El **desarrollo de los visuales generativos** y los mapeos con Tone.js.
...
├── p5js/                  # Visuales y sonido en el navegador (p5.js + Tone.js)
...
- **Sketches de sonido con Tone.js** para mapeo de gestos y sensores.
